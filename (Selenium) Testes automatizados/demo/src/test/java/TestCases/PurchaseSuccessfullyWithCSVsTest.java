...
public class PurchaseSuccessfullyWithCSVsTest extends TestBase {
	...
	@ParameterizedTest
	@Tag("regressão")
	@CsvFileSource(resources = "/CSVs/Users.csv", numLinesToSkip = 1)
	public void purchase(String user, String password) {
		try {
			
			Report.createTest("(CSVs) Realizar compra com sucesso", ReportType.GROUP);
