...
public class PurchaseSuccessfullyWithPropertyValidationTest extends TestBase {
	...
	public void purchase() {
		try {
			...
			Report.createTest("(Properties) Realizar compra com sucesso", ReportType.GROUP);
			
			Report.createStep("Realizar login");
			loginTask.loginUsingPropsFile();
			...
			checkoutFillInformationTask.props_fillAllFieldsInAndContinue();
